<script lang="ts">
	...
	import SectionList from '$lib/sections/receipts_unauthorized/SectionList.svelte';
	import SectionSearch from '$lib/sections/receipts_unauthorized/SectionSearch.svelte';
...
<div in:fade class="flex flex-col p-5 gap-5 w-fit h-full max-w-full">
	<h2 class="font-bold text-3xl text-center">Comprobantes no autorizados</h2>
