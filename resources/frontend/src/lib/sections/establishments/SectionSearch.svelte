<script lang="ts">
    ...
    async function searchEstabs () {
        requestFunctions.loadEstablishments(`/api/establishments?code=${$codeToSearch}&name=${$nameToSearch}`)
...
<div class="flex flex-col gap-4 justify-center">
    ...
    <section class="flex justify-center">
        <button class="flex flex-row gap-2 place-items-center bg-[--color-theme-1] py-1 px-2 rounded-md shadow-sm shadow-black hover:shadow hover:shadow-black hover:bg-blue-600 text-slate-50" on:click={searchEstabs}>
