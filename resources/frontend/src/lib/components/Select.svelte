...
<button class="relative box-border border {alert ? 'border-red-500' : 'border-[--color-border]'} bg-transparent rounded-md px-1 ml-auto h-[26px] w-[205px] place-self-center" >
